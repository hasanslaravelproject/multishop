                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <img src="{{asset('image/product/'.$p->pro_image)}}" alt="" width="75" class="pb-3">
                                                    <p class="card-text">Price: {{$p->pro_price}}</p>
                                                    <p class="card-text">Q.: {{$p->pro_quantity}}</p>
                                                    <p class="card-text">Validity: {{$p->pro_validity}}</p>
                                                    <a href="{{ url('add-to-cart/'.$p->id) }}" class="btn btn-primary">Add To Cart</a>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
...
<div class="addcart_btm_popup" id="fixed_cart_icon">
    <a href="{{ url('cart') }}" class="fixed_cart">
        {{ count((array) session('cart')) }}  <i class="ti-shopping-cart"></i>
    </a>
</div>
<!-- cart end -->
