...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Oct 2020 21:07:41 GMT -->
<head>
        ...
        <div class="row">
            <div class="col-sm-12">
                <table class="table cart-table table-responsive-xs">
                    ...
                    <tbody>
                    <?php $total = 0; $grandtotal = 0; ?>
                    @foreach(session('cart') as $c => $details)
                        <?php $total += $details['price'] * $details['quantity']; ?>
                    <tr>
                        <td>
                            <a href="#"><img src="{{asset('image/product/'.$details['photo'])}}" alt=""></a>
                        </td>
...
<?php $grandtotal = $grandtotal+ $total ?>
        ...
        <div class="row cart-buttons">
            ...
            <div class="col-6"><a href="{{URL::to('payment/'.$grandtotal)}}" class="btn btn-solid">check out</a></div>
        </div>
    </div>
</section>
<!--section end-->
