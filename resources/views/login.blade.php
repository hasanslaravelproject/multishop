                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="top-tabContent">
                                ...
                                <div class="tab-pane fade" id="top-contact" role="tabpanel" aria-labelledby="contact-top-tab">
                                    <form class="form-horizontal auth-form" action="{{URL::to('client-reg')}}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            <input required="" name="name" type="name" class="form-control" placeholder="Username" id="exampleInputEmail12">
                                        </div>
                                        <div class="form-group">
                                            <input required="" name="email" type="email" class="form-control" placeholder="User Email" id="exampleInputEmail12">
                                        </div>
                                        <div class="form-group">
                                            <input required="" name="password" type="password" class="form-control" placeholder="Password">
                                        </div>
